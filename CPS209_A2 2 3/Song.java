...
public class Song extends AudioContent // implement the Comparable interface
{
	...
	public String getInfo() { // added this for SEARCHP: returns a string of all the information we have on a song
		return super.getInfo() + this.artist + this.composer + this.genre + this.lyrics;
	}
